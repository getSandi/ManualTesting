...
| ------------ | ------------ | ---------------------------------------- | ---------------------------------- | ---------------------------------------------------------------------------------- | ------------------------------------------------------------------- |
| Memastikan pengguna dapat login menggunakan username dan password yang valid | TC-LOGIN-001 | Login dengan username dan password valid | `standard_user` / `secret_sauce`   | 1. Masukkan username.<br>2. Masukkan password.<br>3. Klik Login.                   | Pengguna berhasil login dan diarahkan ke halaman Products.          |
